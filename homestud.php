...
<div class="row">
        ...
        while ($row = mysqli_fetch_assoc($res)) {                
          ...
          $quizid = $row['quizid'];
          $sqlCheckTaken = "SELECT * FROM score WHERE usn='$usn' AND quizid='$quizid'";
          $resCheckTaken = mysqli_query($conn, $sqlCheckTaken);
          
          if (mysqli_num_rows($resCheckTaken) > 0) {
              echo "Submitted";
          } else {
              echo "<a id=\"tq\" href='takeq.php?qid=".$quizid."'>Take Quiz</a>";
          }
